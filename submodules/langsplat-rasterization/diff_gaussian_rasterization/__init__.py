...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.f_count:
            ...
            if raster_settings.debug:
                ...
                try:
                    ...
                    per_pixel_gaussian_ids, per_pixel_gaussian_contributions, color, radii  = _C.count_gaussians(*args)
                except Exception as ex:
                    torch.save(cpu_args, "snapshot_fw.dump")
                    print("\nAn error occured in forward. Please forward snapshot_fw.dump for debugging.")
                    raise ex
        ...
        if raster_settings.f_count: 
            ...
            return per_pixel_gaussian_ids, per_pixel_gaussian_contributions, color, radii 
    ...
    def forward_count(
        ...
        #         raise ex
        # else:
        gaussians_count, important_score, rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, per_pixel_gaussian_ids, per_pixel_gaussian_contributions = _C.count_gaussians(*args)
